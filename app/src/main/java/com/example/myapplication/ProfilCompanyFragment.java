...
public class ProfilCompanyFragment extends Fragment {
    ...
    private TextView tv_name,tv_field,tv_description,tv_address_company,btn_offres,update_info_company;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        update_info_company.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("name company",name_company);
                intent.putExtra("profile image",logo_company);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    if(snapshot.child("profile image").getValue()!=null){
                        logo_company=snapshot.child("profile image").getValue().toString();
                        Picasso.get().load(logo_company).into(photo_company);
                    }
                    if(snapshot.child("name company").getValue()!=null){
                         name_company=snapshot.child("name company").getValue().toString();
