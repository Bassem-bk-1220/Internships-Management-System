...
import com.example.myapplication.Adapters.ProfFileDoyenAdapter;
        ...
        myref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataValues : snapshot.getChildren()) {
                    ...
                    if(data.getFileprof()!=null) {
                        listall.add(data);
                    }
                }
                adapter = new ProfFileDoyenAdapter(getContext(), listall);
